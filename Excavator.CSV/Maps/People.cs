...
namespace Excavator.CSV
{
    ...
    partial class CSVComponent
    {
        ...
        void FillInFamilyGroupInfo(string rowFamilyId, int familyGroupTypeId, string[] row)
        {
        ...
        void addToLocationsDictionary(Location familyAddress, string rowFamilyId)
        {
        ...
        /// <returns></returns>
        Group getFamilyGroup(string familyid, ref bool needsAddedToList)
        {
        ...
        Person getPersonRecord(string rowFamilyId, string memberIdValue)
        {
